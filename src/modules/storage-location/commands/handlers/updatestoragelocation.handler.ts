...
import { UpdateStorageLocationCommand } from "../updatestoragelocation.command";
...
{
  constructor(
    private readonly commandService: StorageLocationCommandService
  ) {}
  async execute(command: UpdateStorageLocationCommand) {
