...
@Module({
  controllers: [StorageLocationCommandController],
  providers: [
  ...
  exports: [StorageLocationAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthStorageLocationModule {}
