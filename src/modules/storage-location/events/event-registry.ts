...
import { StorageLocationCreatedEvent } from './storagelocationcreated.event';
import { StorageLocationUpdatedEvent } from './storagelocationupdated.event';
import { StorageLocationDeletedEvent } from './storagelocationdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'storage-location-created': createEventDefinition('storage-location-created', StorageLocationCreatedEvent, EVENT_DEFINITION_OVERRIDES['storage-location-created']),
  'storage-location-updated': createEventDefinition('storage-location-updated', StorageLocationUpdatedEvent, EVENT_DEFINITION_OVERRIDES['storage-location-updated']),
  'storage-location-deleted': createEventDefinition('storage-location-deleted', StorageLocationDeletedEvent, EVENT_DEFINITION_OVERRIDES['storage-location-deleted']),
