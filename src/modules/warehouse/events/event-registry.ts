...
import { WarehouseCreatedEvent } from './warehousecreated.event';
import { WarehouseUpdatedEvent } from './warehouseupdated.event';
import { WarehouseDeletedEvent } from './warehousedeleted.event';
import { WarehouseCapacityUpdatedEvent } from './warehousecapacityupdated.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'warehouse-created': createEventDefinition('warehouse-created', WarehouseCreatedEvent, EVENT_DEFINITION_OVERRIDES['warehouse-created']),
  'warehouse-updated': createEventDefinition('warehouse-updated', WarehouseUpdatedEvent, EVENT_DEFINITION_OVERRIDES['warehouse-updated']),
  'warehouse-deleted': createEventDefinition('warehouse-deleted', WarehouseDeletedEvent, EVENT_DEFINITION_OVERRIDES['warehouse-deleted']),
  'warehouse-capacity-updated': createEventDefinition('warehouse-capacity-updated', WarehouseCapacityUpdatedEvent, EVENT_DEFINITION_OVERRIDES['warehouse-capacity-updated']),
};
